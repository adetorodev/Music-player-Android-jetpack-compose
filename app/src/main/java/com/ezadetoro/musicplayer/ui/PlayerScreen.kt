...
fun PlayerScreen(
    ...
    val song = if(isShuffle) shuffledList.getOrNull(currentIndex) else songList.getOrNull(currentIndex)
        ...
        song?.let {
            ...
            Row(
                ...
                IconButton(onClick = {
                    ...
                    Icon(
                        painter = painterResource(R.drawable.outline_repeat_one_24),
                        contentDescription = null,
